...
short src_ln0 [] = {
	  0,  43,  45,  48,  12,  13,  14,  15, 
	 11,  17,  10,  18,  24,  27,  31,  32, 
	 33,  30,  35,  23,  37,  37,  49,  51, 
	 53,  47,  56,  56,  57,  58,  42,  61, 
	 42,  61,  62,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "phil", 1, 34 },
...
iniglobals(int calling_pid)
{
	...
	{	int l_in;
		for (l_in = 0; l_in < 4; l_in++)
		{
			logval("hunger[l_in]", now.hunger[l_in]);
		}
	}
#endif
}
...
{	/* int i; */
	...
	{	int l_in;
		for (l_in = 0; l_in < 4; l_in++)
		{
			printf("	int    hunger[%d]:	%d\n", l_in, now.hunger[l_in]);
		}
	}
}
void
...
{	/* int i; */
	...
	printf("	int    i:	%d\n", ((P2 *)pptr(pid))->i);
		break;
	case 1:
		printf("local vars proc %d (check):\n", pid);
		break;
	case 0:
